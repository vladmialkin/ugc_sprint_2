...
router.include_router(
    rating_router, prefix="/rating", tags=["Рейтинг фильмов"]
)
router.include_router(
    reviews_router, prefix="/reviews", tags=["Комментарий к фильму"]
)
router.include_router(
    bookmarks_router, prefix="/bookmarks", tags=["Закладки фильмов"]
)
